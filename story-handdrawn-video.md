...
**标题：蜡笔手绘风动画短视频生成 skill软件开发**

**描述：**

专注 AI Agent 技能（skill）定制开发，已做出会动的蜡笔风动画技能，现成作品可先看演示再下单。每一句故事直接生成一段真的在动的蜡笔风视频片段（小猫真在跑、雨真在下），锁定粗黑轮廓、平涂色块、Q 版比例的统一画风；先配音再按旁白时长生成视频，音画对齐不裁不补，字幕用毛笔字体确定性渲染绝不出乱码，还有英语教学卡模式。可按你的内容定制，全部源码交付、支持二次开发。

**服务内容：**

- 1、需求沟通梳理：先聊清楚故事文本、画面风格要求和时长预期，确认对"跨场人物脸不完全一致"的接受度，列明功能清单后再动手
- 2、skill交付内容和格式：9:16 竖屏会动的蜡笔风动画成片：逐场文生视频片段、音画对齐旁白、毛笔字体字幕（或英语教学卡版视频）
- 3、项目功能/系统开发：按你的内容定制画风锁定、场景拆分与教学卡样式，可扩展系列内容批量出片等功能的开发与联调
