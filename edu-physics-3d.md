...
**标题：物理3D互动课件开发 skill软件开发**

**描述：**

专注 AI Agent 技能（skill）定制开发，已做出物理 3D 互动课件技能，现成作品可先看演示再下单。把洛伦兹力、右手定则、原子轨道、晶体结构、电磁波正交传播这些"必须转着看"的内容，变成能旋转、缩放、平移的 3D 网页，滑块驱动箭头和轨迹实时重算，从任意角度看清空间关系。可按你的课程定制，全部源码交付、支持二次开发。

**服务内容：**

- 1、需求沟通梳理：先聊清楚要演示的 3D 物理场景、可调参数和观察重点（方向关系 / 空间结构），列明功能清单后再动手
- 2、skill交付内容和格式：可旋转缩放平移的 3D 交互网页：立体画板（箭头 / 球体 / 轨迹曲线）、滑块控制台、分步推导、守恒定律指示
- 3、项目功能/系统开发：按你的课程定制 3D 对象类型、镜头视角与讲解文案，可扩展整套课件批量生成等功能的开发与联调
